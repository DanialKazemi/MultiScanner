...
public abstract class DiscreteScrollLayoutManagerTest {
    ...
    public void onLayoutChildren_noItems_removesViewsAndResetsState() {
        ...
        assertThat(layoutManager.pendingPosition, is(DiscreteScrollLayoutManager.NO_POSITION));
        assertThat(layoutManager.currentPosition, is(DiscreteScrollLayoutManager.NO_POSITION));
    }
